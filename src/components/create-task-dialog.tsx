...
export default function CreateTaskDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.jiraTicket || formData.jiraLink || formData.prDescription || formData.testingPlan) {
        const metadataResponse = await fetch(`/api/tasks/${newTask.id}/pr-metadata`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
      ...
      setFormData({ title: '', description: '', jiraTicket: '', jiraLink: '', prDescription: '', testingPlan: '' });
      onOpenChange(false);      
        ...
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
          ...
          <div className="flex-1 px-6 py-4 space-y-6 overflow-auto">
            ...
            <div className="border-t pt-4">
              <h3 className="text-sm font-medium mb-4">Pull Request Information (Optional)</h3>

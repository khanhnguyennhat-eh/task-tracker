...
export default function MarkdownPRTemplate({
  ...
  useEffect(() => {
    ...
    let rendered = template
      .replace(
        "{{description}}",
        formData.description || "Add a description of the changes..."
      )
      .replace(
        "{{jiraTicket}}",
        formData.jiraTicket
      ...
      .replace(
        "{{testingPlan}}",
        formData.testingPlan || "Explain how these changes were tested..."
      );
      ...
      return (
        <div key={checkboxKey} className="flex items-start gap-2 mb-1">
          <input
            ...
            className="mt-1"
          />
          <label htmlFor={checkboxKey} className="text-sm cursor-pointer">
            {text}
          </label>
        </div>
      );
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("jiraTicket", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("jiraLink", e.target.value)
                  }
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleInputChange("testingPlan", e.target.value)
                }
          ...
          <div className="pt-2">
            <Button onClick={saveTemplateData} className="w-full">
              Save Template
            </Button>
          </div>
        </div>

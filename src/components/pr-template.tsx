...
export default function PRTemplate({ taskId, initialMetadata }: PRTemplateProps) {
...
## JIRA Ticket
${metadata.jiraTicket ? `[${metadata.jiraTicket}](${metadata.jiraLink || '#'})` : 'Add JIRA ticket reference...'}

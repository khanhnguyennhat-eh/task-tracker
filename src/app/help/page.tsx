...
export const metadata: Metadata = {
  ...
  description:
    "Learn how to use Task Tracker effectively with our documentation and guides",
};
    ...
    <main className="container mx-auto py-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Click the "New Task" button in the top-right corner of the
                Kanban Board or List view to open the task creation dialog.
              </p>
            </div>

            <div>
              <h3 className="font-medium">
                Can I move tasks between statuses?
              </h3>
              <p className="text-muted-foreground">
                Yes, you can drag and drop tasks between columns on the Kanban
                Board. Tasks will follow the defined workflow rules.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Click on any task card to open the task details dialog, where
                you can edit the task description and manage PR checklist items.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-6 p-6 bg-muted rounded-lg flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Contact support or check our detailed documentation
          </p>
        </div>
